...
ax[0].bar(N - width/2, monolithic_memory, width, label='Monolithic', facecolor='tab:blue', edgecolor='black')
ax[0].bar(N + width/2, ALBCD_mem, width, label='ALBCD', facecolor='tab:orange', edgecolor='black')
ax[0].set_xlabel('N')
ax[0].set_ylabel('Memory (MB)')
ax[0].legend()
ax[0].set_title('Uncertain Cart Pole')
...
monolithic_mem = np.array([14.61, 21.81, 28.81, 36.23, 39.67])
...
ax[1].bar(N - width/2, monolithic_mem, width, label='Monolithic', facecolor='tab:blue', edgecolor='black')
ax[1].bar(N + width/2, ALBCD_mem, width, label='ALBCD', facecolor='tab:orange', edgecolor='black')
ax[1].set_xlabel('N')
