...
path = 'examples/dixon_price/data/'
monolithic_mean = np.load(path + 'monolithic_dixon_price_mean_n20.npy')
monolithic_std = np.load(path + 'monolithic_dixon_price_std_n20.npy')

distributed_mean_2 = np.load(path + 'distributed_dixon_price_mean_2subp.npy')
distributed_std_2 = np.load(path + 'distributed_dixon_price_std_2subp.npy')
...
# plt.savefig('dixon_price_random_time.pdf', bbox_inches='tight')
