...
# print('x1_1 history: ', x1_1_history)
# exit()
...
# plt.plot(x1_1_history, x2_1_history, 'o-', color='tab:red', linewidth=2.5, markersize=6, zorder=10)
# plt.plot(x1_2_history, x2_2_history, 'o-', color='tab:blue', linewidth=2.5, markersize=6, zorder=10)
