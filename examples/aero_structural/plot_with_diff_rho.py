...
ax1.semilogy(time_r11, error_r11, color=color_error, label='Error', linewidth=2)
ax1.semilogy(time_r12, error_r12, color='tab:blue', linestyle='--', label='Error (ρ=1.2)', linewidth=2)
ax1.semilogy(time_r15, error_r15, color='tab:blue', linestyle='-.', label='Error (ρ=1.5)', linewidth=2)
ax1.semilogy(time_r20, error_r20, color='tab:blue', linestyle=':', label='Error (ρ=2.0)', linewidth=2)
