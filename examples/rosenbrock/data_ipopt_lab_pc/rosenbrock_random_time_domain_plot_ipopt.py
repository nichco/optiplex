...
path = 'examples/rosenbrock/data_ipopt/'
monolithic_mean = np.load(path + 'monolithic_rosenbrock_mean_n20_IPOPT.npy')
monolithic_std = np.load(path + 'monolithic_rosenbrock_std_n20_IPOPT.npy')

distributed_mean_2 = np.load(path + 'distributed_rosenbrock_mean_2subp_n20_IPOPT.npy')
distributed_std_2 = np.load(path + 'distributed_rosenbrock_std_2subp_n20_IPOPT.npy')

distributed_mean_5 = np.load(path + 'distributed_rosenbrock_mean_5subp_n20_IPOPT.npy')
distributed_std_5 = np.load(path + 'distributed_rosenbrock_std_5subp_n20_IPOPT.npy')

# distributed_mean_10 = np.load(path + 'distributed_rosenbrock_mean_10subp_IPOPT.npy')
# distributed_std_10 = np.load(path + 'distributed_rosenbrock_std_10subp_IPOPT.npy')
