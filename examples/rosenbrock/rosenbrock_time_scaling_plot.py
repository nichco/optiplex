...
plt.semilogy(dimension_slsqp, monolithic_time_slsqp, marker='o', label='Monolithic SLSQP', color='tab:blue', linewidth=2, markersize=8)
...
# plt.savefig('rosenbrock_scaling.pdf', bbox_inches='tight')
plt.show()