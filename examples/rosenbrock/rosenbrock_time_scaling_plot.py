...
plt.semilogy(dimension_slsqp, monolithic_time_slsqp, marker='o', label='Monolithic SLSQP', color='tab:gray', linewidth=1, markersize=8, mec='k')
plt.semilogy(dimension_slsqp, distributed_time_2_subp_slsqp, marker='s', label='Dist. (2 subproblems)', color='tab:blue', linewidth=1, markersize=7, mec='k')
...
plt.semilogy(dimension_slsqp, distributed_time_5_subp_slsqp, marker='d', label='Dist. (5 subproblems)', color='tab:orange', linewidth=1, markersize=7, mec='k')
plt.semilogy(dimension_slsqp, distributed_time_10_subp_slsqp, marker='v', label='Dist. (10 subproblems)', color='tab:green', linewidth=1, markersize=7, mec='k')
